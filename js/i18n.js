...
const I18N = {
  ...
  id: {
    ...
    shortcutSave:    "Simpan",
    shortcutClose:   "Tutup modal / keluar mode imersif",
    ...
    focusToast:      "Mode Fokus — layar penuh, Esc untuk keluar",
    readerToast:     "Mode Baca — Esc untuk keluar, ← → pindah bab",
    focusHint:       "Tulis tanpa distraksi",
    readerHint:      "Baca dengan nyaman",
    shortcutFocus:   "Ctrl+Shift+F",
    shortcutReader:  "Ctrl+Shift+R",
    /* Mode imersif — HUD layar penuh (Mode Fokus & Mode Baca) */
    immersiveGroup:  "Mode Imersif",
    immersiveFullscreen: "Layar penuh otomatis",
    immersiveFullscreenHint: "Mode Fokus & Mode Baca langsung membuka layar penuh browser; Esc untuk keluar.",
    typewriterScroll: "Kursor dijaga di tengah",
    typewriterHint:  "Mode Fokus: baris yang sedang ditulis otomatis digulir ke tengah layar.",
    immersiveControls: "Kontrol mode imersif",
    prevChapter:     "Bab sebelumnya",
    nextChapter:     "Bab berikutnya",
    firstChapter:    "Sudah di bab pertama",
    lastChapter:     "Sudah di bab terakhir",
    wordsCount:      "{n} kata",
    wordCountOne:    "{n} kata",
    smallerFont:     "Perkecil huruf",
    largerFont:      "Perbesar huruf",
    toReaderMode:    "Baca bab ini",
    toFocusMode:     "Kembali menulis",
    exitImmersive:   "Keluar layar penuh",
    fullscreenFail:  "Browser menolak layar penuh — mode tetap aktif.",
    shortcutReaderNav: "Bab sebelumnya / berikutnya (Mode Baca)",
    shortcutReaderScroll: "Gulir halaman (Mode Baca)",
  ...
  en: {
    ...
    shortcutSave:    "Save",
    shortcutClose:   "Close modal / exit immersive mode",
    shortcutIndent:  "Indent / un-indent",
    ...
    focusToast:      "Focus Mode — fullscreen, press Esc to exit",
    readerToast:     "Reader Mode — Esc to exit, ← → to change chapter",
    focusHint:       "Distraction-free writing",
    readerHint:      "Comfortable reading",
    shortcutFocus:   "Ctrl+Shift+F",
    shortcutReader:  "Ctrl+Shift+R",
    /* Immersive modes — fullscreen HUD (Focus & Reader modes) */
    immersiveGroup:  "Immersive Modes",
    immersiveFullscreen: "Automatic fullscreen",
    immersiveFullscreenHint: "Focus & Reader modes open the browser in fullscreen right away; press Esc to leave.",
    typewriterScroll: "Keep the caret centered",
    typewriterHint:  "Focus Mode: the line you are typing is scrolled to the middle of the screen.",
    immersiveControls: "Immersive mode controls",
    prevChapter:     "Previous chapter",
    nextChapter:     "Next chapter",
    firstChapter:    "Already at the first chapter",
    lastChapter:     "Already at the last chapter",
    wordsCount:      "{n} words",
    wordCountOne:    "{n} word",
    smallerFont:     "Decrease font size",
    largerFont:      "Increase font size",
    toReaderMode:    "Read this chapter",
    toFocusMode:     "Back to writing",
    exitImmersive:   "Exit fullscreen",
    fullscreenFail:  "The browser blocked fullscreen — the mode is still active.",
    shortcutReaderNav: "Previous / next chapter (Reader Mode)",
    shortcutReaderScroll: "Turn the page (Reader Mode)",
