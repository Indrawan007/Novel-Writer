...
const I18N = {
  ...
  id: {
    ...
    snapshotFail:    "Gagal membuat cadangan otomatis — restore dibatalkan agar data saat ini aman. Kosongkan penyimpanan lalu coba lagi.",
    ...
    readerToast:     "Mode Baca — Spasi menggulir, Esc keluar",
    shortcutReaderScroll: "Gulir (Mode Baca)",
    shortcutReaderNav: "Bab sebelum/sesudah",
    shortcutFocus:   "Ctrl+Shift+F",
    shortcutReader:  "Ctrl+Alt+R",
    ...
    fmtImage:        "Sisipkan ilustrasi (tokoh/karakter)",
    shortcutBoldItalic: "Tebal / Miring",
    /* Sisipkan ilustrasi */
    insertImage:     "Sisipkan Ilustrasi",
    insert:          "Sisipkan",
    imageFile:       "Berkas gambar",
    imageHint:       "PNG, JPEG, WebP, atau GIF. Gambar diperkecil & dikompres otomatis agar hemat penyimpanan browser, lalu tersimpan di dalam bab ini.",
    imageCaption:    "Nama tokoh / keterangan",
    imageSize:       "Ukuran ilustrasi",
    imageSizeSmall:  "Kecil",
    imageSizeMedium: "Sedang",
    imageSizeFull:   "Penuh",
    imagePick:       "Pilih berkas gambar dulu.",
    imageBadType:    "Jenis berkas tidak didukung — pakai PNG, JPEG, WebP, atau GIF.",
    imageTooBig:     "Gambar terlalu besar (maks 12 MB).",
    imageFail:       "Gambar gagal diproses.",
    imageInserted:   "Ilustrasi disisipkan.",
    imageLarge:      "Gambar ini besar — penyimpanan browser cepat penuh. Cadangkan secara berkala.",
    imageProcessing: "Memproses gambar...",
    figureBarAria:   "Aksi ilustrasi",
    imageReplace:    "Ganti gambar",
    imageReplaceBtn: "Ganti",
    imageDelete:     "Hapus ilustrasi",
    imageReplaced:   "Gambar diganti.",
    imageDeleted:    "Ilustrasi dihapus.",
    storageHeavy:    "Data tersimpan sudah besar — unduh cadangan secara berkala.",
  ...
  en: {
    ...
    snapshotFail:    "Could not create the automatic backup — restore aborted to protect your current data. Free up storage and try again.",
    untitled:        "Untitled",
    chapter:         "Chapter",
    rename:          "Rename",
    ...
    readerToast:     "Reader Mode — Space scrolls, Esc exits",
    shortcutReaderScroll: "Scroll (Reader Mode)",
    shortcutReaderNav: "Previous/next chapter",
    shortcutFocus:   "Ctrl+Shift+F",
    ...
    fmtImage:        "Insert illustration (character)",
    shortcutBoldItalic: "Bold / Italic",
    /* Insert illustration */
    insertImage:     "Insert Illustration",
    insert:          "Insert",
    imageFile:       "Image file",
    imageHint:       "PNG, JPEG, WebP, or GIF. The image is resized and compressed automatically to save browser storage, then kept inside this chapter.",
    imageCaption:    "Character name / caption",
    imageSize:       "Illustration size",
    imageSizeSmall:  "Small",
    imageSizeMedium: "Medium",
    imageSizeFull:   "Full",
    imagePick:       "Pick an image file first.",
    imageBadType:    "Unsupported file type — use PNG, JPEG, WebP, or GIF.",
    imageTooBig:     "Image is too large (max 12 MB).",
    imageFail:       "Could not process the image.",
    imageInserted:   "Illustration inserted.",
    imageLarge:      "This image is large — browser storage fills up fast. Back up regularly.",
    imageProcessing: "Processing image...",
    figureBarAria:   "Illustration actions",
    imageReplace:    "Replace image",
    imageReplaceBtn: "Replace",
    imageDelete:     "Delete illustration",
    imageReplaced:   "Image replaced.",
    imageDeleted:    "Illustration deleted.",
    storageHeavy:    "Stored data is getting large — download a backup regularly.",
